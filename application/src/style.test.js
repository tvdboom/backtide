...
describe('live simulation setup', () => {
  ...
  it('keeps strategy telemetry compact and separates strategy and plot navigation', () => {
    ...
    expect(declaration('.live-observability .live-metrics-table')).toContain('table-layout: fixed')
    expect(declaration('.live-observability .live-metrics-table')).toContain('font-size: 14px')
    expect(declaration('.live-observability .live-metrics-table th, .live-observability .live-metrics-table td'))
      .toContain('padding: 9px 14px')
    ...
    expect(declaration('.live-strategy-panel')).toContain('padding: 0')
    expect(declaration('.live-plot-tabs')).toContain('border-bottom: 0')
    expect(declaration('.live-plot-tabs button')).toContain('justify-content: center')
  })
