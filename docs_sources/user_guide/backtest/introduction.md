...
| **Built-in indicators**      | 12+                              | 100+ (Python)         | ~10 (via ta-lib) | Via pandas-ta   | ❌              |
| **Built-in position sizers** | 7                                | 1                     | 1                | ❌               | ❌              |
| **Multi-asset support**      | ✅                                | ✅                     | ✅                | ✅               | ✅              |
...
**Speed without complexity.** Bar alignment, order matching, portfolio accounting, equity
tracking, FX conversion, indicators, and built-in strategies are optimized for fast simulation.
You can still write custom strategies in plain Python.
