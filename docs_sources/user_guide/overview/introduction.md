...
logic with current market data through simulated live simulation. The application and Python API use
...
5. **Run live.** Observe the strategy on current market updates with simulated fills before
...
- Continue with [Live introduction](../live/introduction.md) and [Live simulation](../live/sessions.md)
...
!!! warning
    Backtide is a research and education tool. Backtests and live simulation simplify execution and
