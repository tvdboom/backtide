...
market data, experiment results, and live-session history; the subdirectories store user-defined
artifacts (strategies, indicators, configs, logs).

```text
.backtide/
├── database.duckdb          # Market data, experiment results, and live-session history
├── strategies/
