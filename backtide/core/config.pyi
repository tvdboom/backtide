...
class DisplayConfig:
    ...
    @data_backend.setter
    def data_backend(self, value: str | DataBackend) -> None: ...
    date_format: str
    @property
    def logokit_api_key(self) -> None: ...
    @logokit_api_key.setter
    def logokit_api_key(self, value: str | None) -> None: ...
    port: int
    time_format: str
    @property
...
class GeneralConfig:
    ...
    def base_currency(self, value: str | Currency) -> None: ...
    log_level: str
    triangulation_crypto: str
    triangulation_crypto_pegged: str
    @property
    def triangulation_fiat(self) -> Currency: ...
    @triangulation_fiat.setter
    def triangulation_fiat(self, value: str | Currency) -> None: ...
    @property
    def triangulation_strategy(self) -> TriangulationStrategy: ...
    @triangulation_strategy.setter
    def triangulation_strategy(self, value: str | TriangulationStrategy) -> None: ...
