...
class DataframeBackend:
    ...
    def __str__(self, /): ...
    @staticmethod
    def variants() -> list[DataframeBackend]: ...
...
class DisplayConfig:
    ...
    address: str | None
    dataframe_backend: str | DataframeBackend
    date_format: str
...
class GeneralConfig:
    ...
    triangulation_fiat: str | Currency
    triangulation_strategy: str | TriangulationStrategy
